...
// console.log(isObject('hello world'));
// console.log(isObject(999));
// console.log(isObject([1, 2, 3]));
// console.log(isObject(null));
// console.log(isObject({ name: 'txusif' }));
...
// console.log(isTrue('hello')); // True
// console.log(isTrue(''));
// console.log(isTrue(null));
// console.log(isTrue(undefined));
// console.log(isTrue({}));
// console.log(isTrue({ name: 'txusif' })); // True
// console.log(isTrue([]));
...
// console.log(processUser({ id: 999, name: 'juice WRLD' }));
// console.log(processUser({ name: 'juice WRLD' }));
